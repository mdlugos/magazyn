...
setpos(3,0)
? padc(" ÛÛÛÛÛÛ Û     Û  ÛÛÛÛÛÛ ÛÛÛÛÛÛÛ ÛÛÛÛÛÛÛ Û       Û",maxcol())
? padc("Û        Û   Û  Û          Û    Û       ÛÛ     ÛÛ",maxcol())
? padc(" ÛÛÛÛÛ    Û Û    ÛÛÛÛÛ     Û    ÛÛÛÛÛÛ  Û Û   Û Û",maxcol())
? padc("      Û    Û          Û    Û    Û       Û  Û Û  Û",maxcol())
? padc("ÛÛÛÛÛÛ     Û    ÛÛÛÛÛÛ     Û    ÛÛÛÛÛÛÛ Û   Û   Û",maxcol())
?
...
IF a<104857600
    aadd(txt,message("TYLKO"+STR(int(a/1024/1024),3)+" MEGABAJTàW;WOLNEGO MIEJSCA NA DYSKU !"))
ENDIF
...
#else
*/
          @ 4,maxcol()/2-29,7,maxcol()/2+30 BOXB "ÉÍ»º¼ÍÈº "
          @ 4,maxcol()/2-4 SAY " M E N U " COLOR if(iscolor(),_sbkgr,"W+")
//#endif

          @ maxrow()-2,0,maxrow(),maxcol() BOXB "ÉÍ»º¼ÍÈº "
