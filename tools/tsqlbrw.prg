...
METHOD Block() CLASS TBColumnSQL
   ...
   DO CASE
   CASE xType == "B"
      xValue := "'" + Str( xValue, ::oBrw:oCurRow:FieldLen( ::nFieldNum ), 8 ) + "'"
...
METHOD EditField() CLASS TBrowseSQL
   ...
   ELSE
      ...
      IF ReadModal( aGetList ) //.and. ::oCurRow:aDirty[ oCol:nFieldNum ]
         // SetCursor( SC_NONE )
