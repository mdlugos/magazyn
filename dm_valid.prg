...
//----------------------------
             ...
             */
             ...
             if round(a+il,3)<=0                //dotaràem do wàaòciwego PZ
...
//#define D_CZ
  ...
  #endif
//tu byào D_CZ
    if D_IZ !nowystan .and. (_fnowy D_KOB .or. il=0 .or. dok_war#"+" .or. (tone(130,3),1=alarm("CZY AKTUALIZOWAè WARTOóè EWIDENCYJN§ DOKUMENTU ?" ,{"TAK","NIE"},2)))
#else
//tu teæ
    if D_IZ (_fnowy .or. il=0 .or. dok_war#"+" .or. (tone(130,3),1=alarm("CZY AKTUALIZOWAè WARTOóè EWIDENCYJN§ DOKUMENTU ?" ,{"TAK","NIE"},2)))
#endif
...
#define A_VAT
  ...
  ENDIF
    ...
    ENDIF
      ...
      @ 13,_scol1+1 SAY 'Nazwa peàna firmy:'
      ...
      do case
         case readkey()=27
              ...
              exit
         case empty(f)
              if tak('WYKASOWAè FIRM®',20,_scol1+5,.f.,.F.)
                 lock
                 delete
                 unlock
                 RESTSCREEN(9,_scol1-1, 20, _scol2,s)
